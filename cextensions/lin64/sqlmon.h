...
#define SQLM_ELM_ADM_BYPASSED                                               1082
                                   /* Estimated peak shared sort memory usage */
#define SQLM_ELM_ESTIMATED_SORT_SHRHEAP_TOP                                 1083
                                   /* Estimated peak sort memory consumers    */
#define SQLM_ELM_ESTIMATED_SORT_CONSUMERS_TOP                               1084
                                   /* Estimated runtime                       */
#define SQLM_ELM_ESTIMATED_RUNTIME                                          1085
                                   /* Comments from SQL statement             */
#define SQLM_ELM_STMT_COMMENTS                                              1086
                                            /* active hash grpbys HWM         */
#define SQLM_ELM_ACTIVE_HASH_GRPBYS_TOP                                     1087
                                            /* active hash joins HWM          */
#define SQLM_ELM_ACTIVE_HASH_JOINS_TOP                                      1088
                                            /* active olap funs HWM           */
#define SQLM_ELM_ACTIVE_OLAP_FUNCS_TOP                                      1089
                                            /* active peas HWM                */
#define SQLM_ELM_ACTIVE_PEAS_TOP                                            1090
                                            /* active peds HWM                */
#define SQLM_ELM_ACTIVE_PEDS_TOP                                            1091
                                            /* active sort consumers HWM      */
#define SQLM_ELM_ACTIVE_SORT_CONSUMERS_TOP                                  1092
                                            /* active sort consumers HWM      */
#define SQLM_ELM_ACTIVE_SORTS_TOP                                           1093
                                            /* active work unit consumers HWM */
#define SQLM_ELM_ACTIVE_COL_VECTOR_CONSUMERS_TOP                            1094
                                            /* sort consumer heap HWM         */
#define SQLM_ELM_SORT_CONSUMER_HEAP_TOP                                     1095
                                            /* sort consumer shrheap HWM      */
#define SQLM_ELM_SORT_CONSUMER_SHRHEAP_TOP                                  1096
