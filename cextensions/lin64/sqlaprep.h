...
#define SQLA_TYPE_CONNECT_ACCESSTOKEN            196
#define SQLA_TYPE_CONNECT_APIKEY                 197
...
SQL_API_RC SQL_API_FN
  sqlgsetasz (
        unsigned short,                    /* SQLDA ID                        */
        sqluint32,                         /* Structure version               */
        sqluint32,                         /* Array Size                      */
        unsigned short,                    /* Is Structure                    */
        sqluint32,                         /* Structure Size                  */
        unsigned short);                   /* Is Indicator a structure        */
